...
@Injectable()
export default class BitmexTestProxy {
  public accountType = "spot";

  public quoteCurrency = "USDT";

  private readonly logger = new Logger(BitmexTestProxy.name);

  // help to track ccxt instances accross all users (for debugging purposes)
  private instanceId: string;

  private Exchange = ccxt.bitmex;

  private exchangeName = "bitmex_test";
