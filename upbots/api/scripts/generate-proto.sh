...
# execute this script under /api folder, ./scripts/generate-proto.sh
echo "generating proto classes ts and js.."
BASEDIR=$(dirname "$0")
cd "${BASEDIR}"/../
...
echo "generating proto classes ended."
