  ...
  <div class="bg-tiber shadow-140 rounded-5 p-15 mb-10 last:mb-0">
    ...
    <div class="grid grid-cols-3 col-gap-20 mb-14">
      ...
      <div class="flex flex-col">
        ...
        <div class="flex">
          <span v-if="data.entryPrice" class="text-white text-xs leading-xs">{{ data.entryPrice }}</span>
          <span v-else class="flex bg-white w-full h-px" />
        </div>
      </div>
      ...
      <div class="flex flex-col">
        ...
        <div class="flex">
          <span v-if="data.closePrice" class="text-white text-xs leading-xs">{{ data.closePrice }}</span>
...
@Component({ name: "BotHistoryItemMobile" })
export default class BotHistoryItemMobile extends Vue {
  /* PROPS */
