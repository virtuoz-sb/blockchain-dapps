<template>
  <GeneralLayout :title="!$breakpoint.smAndDown && 'BSC UBXT STAKING'" content-custom-classes="flex-col overflow-y-auto custom-scrollbar">
    <!-- LINK TO EARN PAGE -->
    <router-link
    ...
    <div class="flex flex-col flex-grow w-full mt-30 md:mt-0 md:pt-40 pb-40 md:pb-0 px-20 md:px-0 overflow-auto custom-scrollbar">
      ...
      <div v-if="$breakpoint.smAndDown" class="flex items-center justify-between flex-shrink-0 mb-30">
        <router-link slot="header-nav-left-start" to="/staking" tag="div" class="flex items-center flex-shrink-0 cursor-pointer">
          ...
          <span class="font-raleway text-md md:text-xl leading:sm md:leading-xs text-iceberg whitespace-no-wrap">BSC UBXT STAKING</span>
        </router-link>
      ...
      <Card :header="false" class="flex flex-col flex-shrink-0 w-full bg-dark-200 rounded-3 mb-40 md:mb-66">
        <template slot="content">
          <div class="grid md:grid-cols-2 xl:grid-cols-3 row-gap-10 md:row-gap-20 xl:row-gap-0 md:col-gap-20 md:p-20">
            <div
            ...
            >
              ...
              <span class="text-white text-xxl2 text-center font-semibold break-all">{{ this.totalUbxtStaked | convertNumberValue }}</span>
            </div>
            ...
            >
              <span class="text-iceberg text-md md:text-xl text-center mb-14">Farm UBXT</span>
              <span class="text-shakespeare text-xxl1 md:text-xxl2 text-center font-semibold break-all">
                {{ this.bscFarmAPY.toFixed(2) }}% APR
              </span>
            </div>
      ...
      <div
        class="ubxt-bsc-ubxt-staking-card__container grid row-gap-40 w-full mb-40 mx-auto"
      ...
      >
            ...
            <div class="flex flex-col flex-grow">
              ...
              <div class="flex">
                <AppButton
                  type="light-green"
                  size="sm"
                  class="ubxt-bsc-ubxt-staking-card__btn flex-shrink-0 max-w-200 w-full mx-auto"
        ...
        <Card
          :header="false"
          class="ubxt-bsc-ubxt-staking-card custom-blur-card flex flex-col flex-shrink-0 w-full bg-dark-200 p-20 mx-auto rounded-10"
        >
          <template slot="content">
            <div class="h-64 mx-auto mb-30">
            ...
            <div class="flex flex-col flex-grow">
              ...
              <div class="flex items-center justify-center w-full mb-30">
                <div class="flex mr-20">
                  <span class="ubxt-bsc-ubxt-staking-card__value text-white text-xxl text-center break-all">
              ...
              <div v-if="isApproved" class="flex items-center justify-center mb-20">
                <AppButton
                  type="light-green"
                  size="sm"
                  class="ubxt-bsc-ubxt-staking-card__btn-plus w-full mr-20"
                ...
                <AppButton
                  type="light-green"
                  size="sm"
                  class="ubxt-bsc-ubxt-staking-card__btn-claim w-full"
              ...
              <div v-else class="flex items-center justify-center mb-20">
                <AppButton
                  type="light-green"
                  size="sm"
                  class="ubxt-bsc-ubxt-staking-card__btn-plus max-w-200 w-full"
...
@Component({ name: "UBXTBSCStaking", components: { GeneralLayout, UBXTModal } })
export default class UBXTBSCStaking extends Vue {
  /* VUEX */
  ...
  ubxtAddress = `${process.env.VUE_APP_BSC_UBXT_ADDRESS}`;
  ...
  async claimPendingReward(): Promise<void> {
    ...
    if (this.ubxtEarned > 0) {
      const amountToClaim = this.ubxtEarned;
      const contract = new this.web3.eth.Contract(this.stakingAbi, this.stakingAddress);
      this.loading = true;
      contract.methods
        .deposit(0, 0)
